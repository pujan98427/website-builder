  ...
  >
    <div class="w-full h-full relative" :style="containerStyles">
      <iframe
        ...
        :title="element.settings?.title || 'Embedded content'"
        :allow="element.settings?.allow"
        :sandbox="element.settings?.sandbox"
        class="w-full h-full"
        :style="iframeStyles"
      ></iframe>
      <div
      ...
      >
        <div class="text-center p-4">
          ...
          <p class="mt-1 text-sm text-gray-600">Enter iframe URL in settings</p>
          <input
            type="text"
            v-model="url"
