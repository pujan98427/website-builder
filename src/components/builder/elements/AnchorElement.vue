<template>
  ...
  >
    <a :href="element.settings.link" :target="element.settings.target"
    class="relative focus:outline-none focus:ring-2 focus:ring-blue-500 rounded-lg whitespace-pre-wrap"
    :style="{
      ...
      @click.stop
    >
        {{ element.settings.text || 'Click to edit anchor' }}
    </a>
